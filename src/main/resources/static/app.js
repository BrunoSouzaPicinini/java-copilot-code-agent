document.addEventListener("DOMContentLoaded", () => {
  ...
  function initializeFilters() {
    ...
    if (activeDifficultyFilter) {
      currentDifficultyLevel = activeDifficultyFilter.dataset.difficulty;
    }
  }
  ...
  // Função para buscar atividades da API com filtros opcionais de dia, horário e nível de dificuldade
  async function fetchActivities() {
    ...
    try {
      ...
      // Lidar com filtro de nível de dificuldade
  ...
  difficultyFilters.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      currentDifficultyLevel = button.dataset.difficulty;
      fetchActivities();
    });
  });
